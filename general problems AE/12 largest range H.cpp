...
vi solve(vi &a){
    ...
    forn(i, a.size()){ 
        if(hmp[a[i]]){
            ...
            int leftElement = a[i] - 1;   
            int rightElement = a[i] + 1;   

            while(hmp[leftElement]){
                hmp[leftElement] = false; 
                count++;   
                leftElement--;      
            }

            while(hmp[rightElement]){
                hmp[rightElement] = false;  
                count++;  
                rightElement++;   
            }
            ...
            if(count > largest){
                largest = count;    
                result[0] = leftElement+1;    
                result[1] = rightElement-1;     
            }
...
int main(){
    ...
    vi a {1, 11, 3, 0, 15, 5, 2, 4, 10, 7, 12, 6};   
    vi result = solve(a);   
    cout << result;      
