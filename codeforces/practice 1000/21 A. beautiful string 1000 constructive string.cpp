    ...
    while(t--){    
        ...
        if(condition){
            forn(i, str.size()-1){
                if(str[i] == '?' && str[i+1] != '?'){
                    if(i == 0){
                        ...
                        if((str[i-1] == 'a' && str[i+1] == 'b') || (str[i-1] == 'b' && str[i+1] == 'a')){
                            str[i] = 'c';   
                        }else if((str[i-1] == 'a' && str[i+1] == 'c') || (str[i-1] == 'c' && str[i+1] == 'a')){
                            str[i] = 'b'; 
                        }else if((str[i-1] == 'b' && str[i+1] == 'c') || (str[i-1] == 'c' && str[i+1] == 'b')){
                            str[i] = 'a';
            ...
            if(str.size() == 1 && str[0] == '?'){
                ...
                if(str[str.size()-1] == '?'){
                    if(str[str.size()-1-1] == 'a'){str[str.size()-1] = 'b'; }
                    else if(str[str.size()-1-1] == 'b'){str[str.size()-1] = 'a'; }
                    else if(str[str.size()-1-1] == 'c'){str[str.size()-1] = 'a'; }       
                }
            }
