...
void solve(){
    ...
    ll t, n, m, l, r, w, x, y, a, b, z, k, temp, answer, mini, maxi, miniIndex, maxiIndex, counter, sum;  
    ...
    while(t--){    
        ...
        forn(i, 2){
            ...
            if(l-w >= x){
                // we can subtract from the same number completely
                l-=w; 
                w=0;    
            }else{
                // we have to subtract from two different numbers
                w-=(l-x);       
                l = l - (l-x);      
