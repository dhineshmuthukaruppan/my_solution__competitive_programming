...
#define sortallr(x) sort(all(x), greater<int>())
...
void solve(){
    ...
    while(t--){    
        ...
        int currentStarting = -1;   
        forn(i, str.size()){

            if(str[i] == '1'){     
                currentCounter++;   
                if(currentStarting == -1){ 
                    currentStarting=i;    
                }
            }else{
                if(currentStarting != -1){
                    a.push_back(currentCounter);    
                    currentCounter = 0;   
                    currentStarting = -1;      
                }
            }
        ...
        if(currentCounter > 0){a.push_back(currentCounter); }   
