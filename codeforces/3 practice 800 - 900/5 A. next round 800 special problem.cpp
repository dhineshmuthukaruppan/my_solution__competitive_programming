...
void solve(){
    ...
    if(a[currentIndex] == 0){          
        while(a[currentIndex] == 0 && currentIndex > 0){
            currentIndex--;   
        } 
        if(a[currentIndex] == 0){
            // index is currently on 0 
            cout << 0 << newl;   
        }else{
            cout << currentIndex +1 << newl;      
        }     

    }else{   
        int targetValue = a[currentIndex];   
        while(currentIndex < a.size() && a[currentIndex] >= targetValue){   
            currentIndex++;        
        }

        cout << currentIndex  << newl;             
