...
void solve(){
    ...
    while(t--){    
        ...
        if(c>=a && c<=b){
            // station inside 
            // totalTravel is also going to denote unavailable duration
            if((c-r) <= a){
                totalTravel -= (c-a); 
            }else{
                totalTravel -= ((c-a) - (c-a-r));    
            }

            if(c+r >= b){
                totalTravel -= (b-c);     
            }else{
                totalTravel -= ((b-c) - (b-c-r));       
            }
            ...
            if(c-r <= a){
                ...
                totalTravel -= ((c-(c-r)) - (c-b));         
            }else{
                // do nothing
            }
        }

        cout << totalTravel << newl;     
