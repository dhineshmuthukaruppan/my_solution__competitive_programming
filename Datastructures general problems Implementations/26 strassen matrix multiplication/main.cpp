...
// O(N^3)
vvi matrixMultiplicationIterative(vvi a, vvi b){   

    vvi result(a.size(), vector<int>(b[0].size()));   
...
}  /* end of matrixMultiplicationIterative */
...
int main(){
    ...
    vvi result = matrixMultiplicationIterative({{2, 1}, {2, 1}, {2, 1}}, {{3, 3, 1}, {1, 1, 3}});      
    cout << result << newl;    
