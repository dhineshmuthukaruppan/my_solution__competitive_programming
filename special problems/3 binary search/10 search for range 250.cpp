...
vector<int> solve(vector<int> &a, int elem){

    vector<int> result;   

    vector<int>::iterator l = lower_bound(a.begin(), a.end(), elem);   
    vector<int>::iterator u = upper_bound(a.begin(), a.end(), elem);   
    ...
    if(l == a.end()){
        ...
        result.push_back(l - a.begin());   
        result.push_back(u - a.begin() - 1);                 
